...
namespace NKHook6.Api.Utilities
{
    public class CameraUtils
    {
        ...
        [HarmonyPatch(typeof(MonkeyAnimationController), "Awake")]
        public class FunnyTposeMod4
        {
            [HarmonyPrefix]
            public static bool Prefix(MonkeyAnimationController __instance)
            {
                __instance.animationStates = new Il2CppSystem.Collections.Generic.List<AnimationBakerStateConfig>();
                __instance.animationChanges = new Il2CppSystem.Collections.Generic.List<AnimationChange>();
                __instance.IdleVariants = new Il2CppSystem.Collections.Generic.List<AnimationBakerVariantStateConfig>();
                __instance.attackIdleConfigs = new Il2CppSystem.Collections.Generic.List<AnimationBakerStateConfig>();
                __instance.placementConfigs = new Il2CppSystem.Collections.Generic.List<AnimationBakerStateConfig>();
                __instance.animationStatesByIndex = new Il2CppSystem.Collections.Generic.List<AnimationBakerStateConfig>();
                return true;
            }

            [HarmonyPostfix]
            public static void Postfix(MonkeyAnimationController __instance)
            {
