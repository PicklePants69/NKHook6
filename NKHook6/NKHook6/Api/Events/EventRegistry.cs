    ...
    public class EventRegistry
    {
        ...
        internal EventRegistry()
        {
            ...
            List<string> CustomEvents = new List<string>()
            {
                ...
                "Tower.InitialiseEvent",  //need change on wiki
                "Tower.OnDestroyEvent",  //need change on wiki
                "Tower.OnSoldEvent",  //need change on wiki
                ...
                "InGame.UpdateEvent",
                "Simulation.OnRoundStartEvent",  //need change on wiki
                "Simulation.OnRoundEndEvent",  //need change on wiki
