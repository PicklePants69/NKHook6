...
namespace NKHook6.Patches.Bloons
{
    ...
    class BloonDamagedHook
    {
        ...
        ref bool blockSpawnChildren)
        {
            ...
            if (sendPrefixEvent)
            {
                var o = new BloonDamagedEvent.Prefix(ref __instance, ref totalAmount, ref types, ref projectile,
        ...
        ref bool blockSpawnChildren)
        {
            if (sendPostfixEvent)
            {
                var o = new BloonDamagedEvent.Postfix(ref __instance, ref totalAmount, ref types, ref projectile,
                    ref distributeToChildren, ref overrideDistributeBlocker, ref createEffect, ref tower,
                    ref canDestroyProjectile, ref ignoreImmunityForBloonTypes, ref ignoreNonTargetable,
                    ref blockSpawnChildren);
                EventRegistry.subscriber.dispatchEvent(ref o);
