namespace NKHook6.Patches._Weapons
{
	...
	class InitialiseHook
	{
		...
		internal static bool Prefix(ref Weapon __instance, ref Entity target, ref Model modelToUse)
		{
			...
			if (sendPrefixEvent)
			{
				var o = new WeaponEvents.InitialiseEvent.Pre(ref __instance, ref target, ref modelToUse);
		...
		internal static void Postfix(ref Weapon __instance, ref Entity target, ref Model modelToUse)
		{
			if (sendPostfixEvent)
			{
				var o = new WeaponEvents.InitialiseEvent.Post(ref __instance, ref target, ref modelToUse);
				EventRegistry.subscriber.dispatchEvent(ref o);
				__instance = o.instance;
				target = o.entity;
				modelToUse = o.model;
